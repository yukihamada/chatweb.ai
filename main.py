...
- 用途に合わせたサイズ: SNSバナー(1200x630), Instagram(1080x1080), ポスター(768x1024)""",
    ...
    "video": {
        ...
        "system": """あなたは動画生成専門エージェントです。

## 使えるツール
- **video_generate**: テキストから短尺動画を生成
...
## 動画の種類
- **プロモーション動画**: 製品紹介、サービス紹介
- **SNSリール**: Instagram/TikTok向け縦型ショート動画
- **ロゴアニメーション**: ロゴが動くイントロ
- **テキストアニメーション**: テキストが動く動画
- **風景・雰囲気動画**: 背景映像、ループ動画

日本語で指示されても英語に翻訳してから生成してください。""",
    },
    "travel": {
        "name": "🚄 旅行AI",
        "color": "#0ea5e9",
...
- video   : AI動画生成・プロモーション動画・リール・アニメーション・「動画を作って」「ビデオ」「ムービー」・SNSリール
